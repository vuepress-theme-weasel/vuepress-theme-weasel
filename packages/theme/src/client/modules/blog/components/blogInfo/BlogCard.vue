    ...
    <div class="social-media-wrapper">
      <a
        ...
        ><svg
          ...
          class="icon baidu-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="baidu"
        >
          <circle cx="512" cy="512" r="512" fill="#1D2FE3"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon bitbucket-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="bitbucket"
        >
          <circle cx="512" cy="512" r="512" fill="#205081"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon dingding-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="dingding"
        >
          <circle cx="512" cy="512" r="512" fill="#1C9DF7"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          ...
          viewBox="0 0 1024 1024"
          arialabelledby="discord"
        >
          <circle cx="512" cy="512" r="512" fill="#2DAAE1"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon dribbble-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="dribbble"
        >
          <circle cx="512" cy="512" r="512" fill="#DC4373"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon evernote-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="evernote"
        >
          <circle cx="512" cy="512" r="512" fill="#36D613"></circle>
          ,
          <path d="M347.671 193.259v87.51h-87.51z" fill="#595757"></path>
          ,
          <path
      ...
      ><a
        ...
        >
          <circle cx="512" cy="512" r="512" fill="#3C599B"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon flipboard-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="flipboard"
        >
          <circle cx="512" cy="512" r="512" fill="#E12828"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon gitee-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="gitee"
        >
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon gitlab-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="gitlab"
        >
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon gmail-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="gmail"
        >
          <circle cx="512" cy="512" r="512" fill="#DB4437"></circle>
          ,
          <path
      ...
      ><a
        ...
        >
          <circle cx="512" cy="512" r="512" fill="#181818"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon lines-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="lines"
        >
          <circle cx="512" cy="512" r="512" fill="#00C300"></circle>
          ,
          <path
      ...
      ><a
        ...
        >
          <circle cx="512" cy="512" r="512" fill="#4376B1"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon pocket-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="pocket"
        >
          <circle cx="512" cy="512" r="512" fill="#EE4056"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon qzone-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="qzone"
        >
          <circle cx="512" cy="512" r="512" fill="#0985DD"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon reddit-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="reddit"
        >
          <circle cx="512" cy="512" r="512" fill="#EB5528"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          ...
          arialabelledby="rss"
        >
          <circle cx="512" cy="512" r="512" fill="#FD9B00"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon steam-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="steam"
        >
          <circle cx="512" cy="512" r="488" fill="#fff"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          ...
          viewBox="0 0 1024 1024"
          arialabelledby="weibo"
        >
          <circle cx="512" cy="512" r="512" fill="#E6162D"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          ...
          viewBox="0 0 1024 1024"
          arialabelledby="whatsapp"
        >
          <circle cx="512" cy="512" r="512" fill="#31B84C"></circle>
          ,
          <path
      ...
      ><a
        ...
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon zhihu-icon"
          viewBox="0 0 1024 1024"
          arialabelledby="zhihu"
        >
