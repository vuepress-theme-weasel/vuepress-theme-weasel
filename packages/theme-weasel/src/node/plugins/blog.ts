...
import type { WeaselThemeBlogPluginOptions } from '../../typings'

const defaultOptions: WeaselThemeBlogPluginOptions = {
  article: '/article/',
  category: '/category/',
...
export const getBlogOptions = (
  options?: WeaselThemeBlogPluginOptions | boolean
): WeaselThemeBlogPluginOptions => ({
  ...defaultOptions,
