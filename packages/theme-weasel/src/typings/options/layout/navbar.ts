import type { WeaselThemeNavbarConfig } from "../../navbar";

export interface WeaselThemeNavbarLocaleData {
  /**
...
export interface WeaselThemeNavbarLocaleOptions {
  /**
   * Navbar config
   *
   * @description Set to `false` to disable navbar in current locale
   * @see https://vuepress-theme-Weasel.github.io/v2/guide/layout/navbar.html
   *
   * 导航栏配置
   *
   * @description 设置 `false` 以在当前语言中禁用导航栏
   * @see https://vuepress-theme-Weasel.github.io/v2/zh/guide/layout/navbar.html
   */
  navbar?: WeaselThemeNavbarConfig | false;
